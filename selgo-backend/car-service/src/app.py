...
from .api.routes import router as car_router
...
app = FastAPI(
    title="Selgo Car Service",
    description="API for car listings and related operations",
    version="0.1.0",
)
...
async def health_check():
    return {"status": "healthy", "service": "car", "version": "0.1.0"}
